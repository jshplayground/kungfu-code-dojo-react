  ...
  return <div className="flex w-full min-h-[90vh] justify-center items-center bg-transparent overflow-hidden relative" ref={scope}>
      ...
      <Floating sensitivity={1} className="overflow-hidden">
        <FloatingElement depth={0.5} className="top-[5%] left-[11%]">
          <motion.img initial={{
          opacity: 0
        }} src="/lovable-uploads/1836d83c-3cb1-4a8f-ae44-419a0d1a0577.png" alt="DotCSV en posición de combate" className="w-32 h-32 md:w-48 md:h-48 object-cover hover:scale-105 duration-200 cursor-pointer transition-transform rounded-xl" />
        </FloatingElement>
        <FloatingElement depth={1} className="top-[8%] left-[70%]">
          <motion.img initial={{
          opacity: 0
        }} src="https://images.unsplash.com/photo-1488590528505-98d2b5aba04b?ixlib=rb-4.0.3" alt="Código de programación" className="w-24 h-24 md:w-36 md:h-36 object-cover hover:scale-105 duration-200 cursor-pointer transition-transform rounded-xl" />
        </FloatingElement>
        ...
        <FloatingElement depth={1} className="top-[45%] left-[75%]">
          <motion.img initial={{
          opacity: 0
        }} src="https://images.unsplash.com/photo-1550751827-4bd374c3f58b?ixlib=rb-4.0.3" alt="Algoritmos de IA" className="w-32 h-32 md:w-44 md:h-44 object-cover hover:scale-105 duration-200 cursor-pointer transition-transform rounded-xl" />
        </FloatingElement>
      </Floating>
    </div>;
};
