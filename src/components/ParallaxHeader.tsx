    ...
    >
      ...
      <Floating sensitivity={1} className="overflow-hidden">
        ...
        <FloatingElement depth={1} className="top-[8%] left-[70%]">
          <motion.img 
            initial={{ opacity: 0 }} 
            src="/lovable-uploads/c9ee0fa4-a239-4dff-86e4-d49c9558a11d.png" 
        ...
        <FloatingElement depth={2} className="top-[50%] left-[15%]">
          <motion.img 
            ...
            src="/lovable-uploads/b073ac69-7851-4b6c-becf-fa59eb52cab3.png" 
            className="w-40 h-28 md:w-40 md:h-40 object-cover hover:scale-105 duration-200 cursor-pointer transition-transform rounded-xl" 
          />
        </FloatingElement>
