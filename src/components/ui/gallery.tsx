...
export const PhotoGallery = ({
  ...
  return (
    <div className="mt-20 relative">
      ...
      <h3 className="z-20 mx-auto max-w-2xl justify-center bg-gradient-to-r from-gray-200 via-white to-gray-200 bg-clip-text py-3 text-center text-4xl text-transparent md:text-6xl">
        {title.split(" ").map((word, i) => (
          <span key={i} className={i % 3 === 0 ? "text-kungfu-red" : ""}>
            {word}{" "}
          </span>
        ))}
      </h3>
      ...
      <div className="flex w-full justify-center">
        <Button 
          variant="default" 
          className="bg-kungfu-red hover:bg-kungfu-red-darker"
          onClick={onClick}
        >
          {buttonText}
        </Button>
